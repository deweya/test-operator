...
import (
	...
	adeweyv1 "github.com/deweya/test-operator/pkg/apis/adewey/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &adeweyv1.HelloWorld{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *adeweyv1.HelloWorld) *corev1.Pod {
